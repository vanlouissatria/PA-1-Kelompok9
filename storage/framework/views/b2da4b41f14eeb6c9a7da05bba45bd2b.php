<?php $__env->startSection('title', 'Tambah Penginapan'); ?>
...
<div class="card card-bi">
    ...
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/penginapan')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="no_telepon" class="form-control form-control-bi" value="<?php echo e(old('no_telepon')); ?>">
                </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="<?php echo e(url('/admin/geosite/'.$geosite.'/penginapan')); ?>" class="btn btn-bi-outline"><i class="fas fa-arrow-left me-2"></i> Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/penginapan/create.blade.php ENDPATH**/ ?>