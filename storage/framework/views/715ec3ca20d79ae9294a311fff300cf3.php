...
<head>
    ...
    <title>Sibea Bea - Geosite Danau Toba</title>
...
.hero::before {
    ...
    width: 100%;
    height: 100%;
    background: url('/image/sibeabea/sibeabea.jpg');
...
<div class="navbar" id="navbar">
    <div class="nav-container">
        <div class="nav-logo">
            <img src="<?php echo e(asset('image/logo/logobankindonesia.jpg')); ?>" alt="Logo BI">
            <div class="logo-divider"></div>
            <img src="<?php echo e(asset('image/logo/del.jpg')); ?>" alt="Logo Del">
            <div class="logo-divider"></div>
            <div class="logo-text">
...
<section class="hero">
    <div data-aos="fade-up">
        <h1 class="hero-title">Sibea Bea</h1>
...
<section id="informasi" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Informasi Wisata Sibea Bea</h2>
            <div class="divider"></div>
            <p>Persiapkan perjalanan Anda dengan informasi terbaru seputar Sibea Bea.</p>
        </div>
        <?php if(isset($informasi) && $informasi->count()): ?>
            <?php $__currentLoopData = $informasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="informasi-card" data-aos="fade-up">
                    <?php if($info->gambar && file_exists(public_path($info->gambar))): ?>
                        <div class="informasi-image"><img src="<?php echo e(image_url($info->gambar)); ?>" alt="<?php echo e($info->judul); ?>"></div>
                    <?php endif; ?>
                    <div class="informasi-content"><h3><?php echo e($info->judul); ?></h3><div class="informasi-text"><?php echo nl2br(e($info->konten)); ?></div></div>
                </div>
...
<section id="galeri" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Galeri Sibea Bea</h2>
            <div class="divider"></div>
            <p>Dokumentasi pemandangan dan aktivitas wisata di Sibea Bea.</p>
        </div>
        <div class="galeri-grid">
            <?php $__empty_1 = true; $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="galeri-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <img src="<?php echo e($gambarUrl); ?>" alt="<?php echo e($item->judul); ?>">
                    <div class="galeri-overlay"><h4><?php echo e($item->judul); ?></h4><p><?php echo e(Str::limit($item->deskripsi ?? '', 60)); ?></p></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state"><i class="fas fa-images"></i><p>Belum ada galeri Sibea Bea.</p></div>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<section id="umkm" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>UMKM Lokal</h2>
            <div class="divider"></div>
            <p>Produk usaha masyarakat sekitar Sibea Bea.</p>
        </div>
        <div class="grid-umkm">
            <?php $__empty_1 = true; $__currentLoopData = $umkm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <div class="image-wrapper">
                        ...
                        ?>
                        <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($item->nama_usaha); ?>">
                        <span class="category-badge"><?php echo e($item->kategori ?? 'UMKM'); ?></span>
                    </div>
                    <div class="card-body">
                        <h4><?php echo e($item->nama_usaha); ?></h4>
                        <div class="info-item"><i class="fas fa-user"></i><span><?php echo e($item->pemilik ?? 'Tidak tersedia'); ?></span></div>
                        <div class="deskripsi"><?php echo e(Str::limit($item->deskripsi ?? 'Deskripsi belum tersedia', 100)); ?></div>
                        <div class="info-item"><i class="fas fa-map-marker-alt"></i><span><?php echo e(Str::limit($item->alamat ?? 'Lokasi tidak tersedia', 60)); ?></span></div>
                        <?php if($item->no_telepon): ?>
                            <div class="info-item"><i class="fas fa-phone-alt"></i><span><?php echo e($item->no_telepon); ?></span></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state"><i class="fas fa-store"></i><p>Belum ada data UMKM untuk Sibea Bea.</p></div>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<section id="penginapan" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Penginapan</h2>
            <div class="divider"></div>
            <p>Rekomendasi tempat menginap di sekitar Sibea Bea.</p>
        </div>
        <div class="grid-penginapan">
            <?php $__empty_1 = true; $__currentLoopData = $penginapan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <div class="image-wrapper">
                        <?php
                        ...
                        ?>
                        <img src="<?php echo e($gambarUrl); ?>" alt="<?php echo e($item->nama); ?>">
                    </div>
                    <div class="card-body">
                        <h4><?php echo e($item->nama); ?></h4>
                        <div class="deskripsi"><?php echo e(Str::limit($item->deskripsi ?? 'Deskripsi tidak tersedia', 80)); ?></div>
                        <div class="info-item"><i class="fas fa-map-marker-alt"></i><span><?php echo e(Str::limit($item->alamat ?? 'Alamat tidak tersedia', 50)); ?></span></div>
                        <?php if($item->no_telepon): ?>
                            <div class="info-item"><i class="fas fa-phone-alt"></i><span><?php echo e($item->no_telepon); ?></span></div>
                        <?php endif; ?>
                        <?php if($item->harga): ?>
                            <div class="harga">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?> <span style="font-size:0.8rem;">/ malam</span></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state"><i class="fas fa-hotel"></i><p>Belum ada data penginapan untuk Sibea Bea.</p></div>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<section id="fasilitas" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Fasilitas</h2>
            <div class="divider"></div>
            <p>Fasilitas pendukung wisata di Sibea Bea.</p>
        </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="deskripsi"><?php echo e(Str::limit($item->deskripsi ?? 'Deskripsi tidak tersedia', 80)); ?></div>
                        <?php if($item->harga): ?>
                            <div class="harga">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state"><i class="fas fa-concierge-bell"></i><p>Belum ada data fasilitas untuk Sibea Bea.</p></div>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<footer class="footer">
    <div class="footer-top" data-aos="fade-up">
        <a href="<?php echo e(url('/')); ?>" class="nav-link footer-home-btn">Kembali ke Home</a>
    </div>
...
</html><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/geosite/sibea.blade.php ENDPATH**/ ?>