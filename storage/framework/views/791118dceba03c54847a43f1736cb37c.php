<?php $__env->startSection('title', 'Terbentuknya Danau Toba - GeoToba'); ?>
...
<div class="page-wrapper">
    ...
    <section class="info-showcase-section">
        <div class="info-showcase-container">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $informasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="info-showcase-row">
                    
                    <div class="info-image-block">
                        <div class="info-image-wrapper">
                            <?php if($info->gambar && file_exists(public_path($info->gambar))): ?>
                                <img src="<?php echo e(asset($info->gambar)); ?>" alt="<?php echo e($info->judul); ?>" loading="lazy">
                            <?php else: ?>
                    ...
                    <div class="info-content-block">
                        <div class="info-meta-index">
                            <?php echo e(sprintf('%02d', ($index + 1))); ?> — INFORMASI
                        </div>
                        
                        <h2 class="info-showcase-title"><?php echo e($info->judul); ?></h2>
            ...
            <?php if(method_exists($informasi, 'links')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/pages/informasi.blade.php ENDPATH**/ ?>