    ...
    <div class="container">
        ...
        <div class="galeri-grid">
            ...
            <div class="galeri-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                ...
                ?>
                <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($item->judul); ?>">
                <div class="galeri-overlay">
                    <h4><?php echo e($item->judul); ?></h4>
                    <p><?php echo e(Str::limit($item->deskripsi, 50)); ?></p>
                </div>
            </div>
            ...
            <div class="card-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="info-item">
                        ...
                        <span><?php echo e($item->pemilik ?? 'Tidak tersedia'); ?></span>
                    </div>
                    <div class="deskripsi"><?php echo e(Str::limit($item->deskripsi ?? 'Tidak ada deskripsi', 100)); ?></div>
                    <div class="info-item">
                        <i class="fas fa-map-marker-alt"></i>
                        <span><?php echo e(Str::limit($item->alamat ?? 'Lokasi tidak tersedia', 60)); ?></span>
                    </div>
                    <?php if($item->no_telepon): ?>
                    <div class="info-item">
                        <i class="fas fa-phone-alt"></i>
                        <span><?php echo e($item->no_telepon); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="grid-penginapan">
            ...
            <div class="card-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="deskripsi"><?php echo e(Str::limit($item->deskripsi ?? 'Tidak ada deskripsi', 80)); ?></div>
                    <div class="info-item">
                        <i class="fas fa-map-marker-alt"></i>
                        <span><?php echo e(Str::limit($item->alamat ?? 'Alamat tidak tersedia', 50)); ?></span>
                    </div>
                    <?php if($item->no_telepon): ?>
                    <div class="info-item">
                        <i class="fas fa-phone-alt"></i>
                    ...
                    <?php endif; ?>
                    <?php if($item->harga): ?>
                    <div class="harga">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?> <span style="font-size: 0.7rem;">/ malam</span></div>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
</html><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/geosite/tele.blade.php ENDPATH**/ ?>