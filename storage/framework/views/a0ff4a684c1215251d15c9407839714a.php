...
<div class="card card-bi">
    <div class="card-header card-header-bi">
        <h5><i class="fas fa-edit me-2" style="color: #D4AF37;"></i> Edit Foto Galeri: <?php echo e($galeri->judul); ?></h5>
    </div>

    <div class="card-body p-4">
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/galeri/'.$galeri->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            
            <div class="mb-4">
                <label class="form-label-bi">Judul Foto *</label>
                <input type="text" name="judul" class="form-control form-control-bi" value="<?php echo e(old('judul', $galeri->judul)); ?>" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label-bi">Deskripsi</label>
                <textarea name="deskripsi" class="form-control form-control-bi" rows="3"><?php echo e(old('deskripsi', $galeri->deskripsi)); ?></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-3">
                    ...
                    <img src="<?php echo e(asset($galeri->gambar)); ?>" id="imgPreview" class="preview-image" alt="Preview">
                </div>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="<?php echo e(url('/admin/geosite/'.$geosite.'/galeri')); ?>" class="btn btn-bi-outline"><i class="fas fa-arrow-left me-2"></i> Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/galeri/edit.blade.php ENDPATH**/ ?>