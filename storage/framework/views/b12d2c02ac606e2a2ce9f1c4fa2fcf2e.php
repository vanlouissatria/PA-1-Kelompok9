...
<style>
    ...
    .slide-1{ background-image: linear-gradient(125deg, rgba(0,30,60,0.7) 0%, rgba(0,80,120,0.5) 40%, rgba(0,30,60,0.7) 100%), url('<?php echo e(asset('image/home/tele1.jpg')); ?>'); }
    .slide-2{ background-image: linear-gradient(125deg, rgba(0,40,70,0.7) 0%, rgba(212,175,55,0.2) 40%, rgba(0,40,70,0.7) 100%), url('<?php echo e(asset('image/home/efrata5.jpg')); ?>'); }
    .slide-3{ background-image: linear-gradient(125deg, rgba(0,20,50,0.7) 0%, rgba(100,150,200,0.3) 40%, rgba(0,20,50,0.7) 100%), url('<?php echo e(asset('image/home/sihotang2.jpg')); ?>'); }
    .slide-4{ background-image: linear-gradient(125deg, rgba(0,35,65,0.7) 0%, rgba(212,175,55,0.25) 40%, rgba(0,35,65,0.7) 100%), url('<?php echo e(asset('image/home/sihotang3.jpg')); ?>'); }
    .slide-5{ background-image: linear-gradient(125deg, rgba(0,25,55,0.7) 0%, rgba(80,130,180,0.35) 40%, rgba(0,25,55,0.7) 100%), url('<?php echo e(asset('image/home/efrata1.jpg')); ?>'); }
...
<section class="category-section">
    <div class="container">
        ...
        <div class="category-grid">
            ...
            <?php $__currentLoopData = $destinasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="category-card" data-aos="fade-up">
                    ...
                    <div class="card-image">
                        <img src="<?php echo e($gambar); ?>" alt="<?php echo e($item->nama_destinasi); ?>">
                        <div class="card-overlay"></div>
                    </div>

                    <div class="card-content">
                        <h3><?php echo e($item->nama_destinasi); ?></h3>

                        <p>
                            <?php echo e(\Illuminate\Support\Str::limit($item->deskripsi, 120)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/destinasi/index.blade.php ENDPATH**/ ?>