<?php $__env->startSection('title', 'Edit Penginapan'); ?>
...
<div class="card">
    <div class="card-header">
        <h5><i class="fas fa-bed me-2"></i> Edit Penginapan: <?php echo e($penginapan->nama); ?></h5>
    </div>

    <div class="card-body p-4">
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/penginapan/'.$penginapan->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="nama" class="form-control" value="<?php echo e(old('nama', $penginapan->nama)); ?>" required>
                </div>
                
                <div class="col-md-6 mb-4">
                    <label class="form-label">No Telepon</label>
                    <input type="text" name="no_telepon" class="form-control" value="<?php echo e(old('no_telepon', $penginapan->no_telepon)); ?>">
                </div>
                
                <div class="col-md-12 mb-4">
                    <label class="form-label">Alamat</label>
                    <textarea name="alamat" class="form-control" rows="2"><?php echo e(old('alamat', $penginapan->alamat)); ?></textarea>
                </div>
                
                <div class="col-md-12 mb-4">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control" rows="3"><?php echo e(old('deskripsi', $penginapan->deskripsi)); ?></textarea>
                </div>
                
                <div class="col-md-6 mb-4">
                    <label class="form-label">Harga per Malam</label>
                    <input type="number" name="harga" class="form-control" value="<?php echo e(old('harga', $penginapan->harga)); ?>" placeholder="0">
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="preview-container">
                        ...
                        <img src="<?php echo e(image_url($penginapan->gambar)); ?>" id="imgPreview" class="preview-image" alt="Preview">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="<?php echo e(url('/admin/geosite/'.$geosite.'/penginapan')); ?>" class="btn-outline-bi"><i class="fas fa-arrow-left me-2"></i> Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/penginapan/edit.blade.php ENDPATH**/ ?>