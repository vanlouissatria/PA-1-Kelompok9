...
<div class="card card-bi">
    <div class="card-header card-header-bi">
        <h5><i class="fas fa-info-circle me-2" style="color: #D4AF37;"></i> Tambah Informasi Baru</h5>
    </div>
    ...
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/informasi')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            
            <div class="mb-4">
                <label class="form-label-bi">Judul Informasi *</label>
                <input type="text" name="judul" class="form-control form-control-bi" value="<?php echo e(old('judul')); ?>" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label-bi">Isi Konten *</label>
                <textarea name="isi" class="form-control form-control-bi" rows="10" required><?php echo e(old('isi')); ?></textarea>
            </div>
            
            <div class="mb-4">
                <label class="form-label-bi">Gambar (Opsional)</label>
            ...
            <div class="d-flex gap-3">
                <button type="submit" class="btn btn-bi-primary"><i class="fas fa-save me-2"></i> Simpan Informasi</button>
                <a href="<?php echo e(url('/admin/geosite/'.$geosite.'/informasi')); ?>" class="btn btn-bi-outline"><i class="fas fa-arrow-left me-2"></i> Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/informasi/create.blade.php ENDPATH**/ ?>