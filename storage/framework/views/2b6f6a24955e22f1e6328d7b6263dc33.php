...
<div class="card card-bi">
    ...
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/umkm')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-6 mb-4">
                    <label class="form-label-bi">Nama UMKM *</label>
                    <input type="text" name="nama_usaha" class="form-control form-control-bi" value="<?php echo e(old('nama_usaha')); ?>" required>
                </div>
                
                <div class="col-md-6 mb-4">
                    <label class="form-label-bi">Pemilik *</label>
                    <input type="text" name="pemilik" class="form-control form-control-bi" value="<?php echo e(old('pemilik')); ?>" required>
                </div>
                
                <div class="col-md-6 mb-4">
                    <label class="form-label-bi">No Telepon *</label>
                    <input type="text" name="no_telepon" class="form-control form-control-bi" value="<?php echo e(old('no_telepon')); ?>" required>
                </div>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea name="alamat" class="form-control form-control-bi" rows="2"><?php echo e(old('alamat')); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/umkm/create.blade.php ENDPATH**/ ?>