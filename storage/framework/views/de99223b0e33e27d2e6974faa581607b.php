    ...
    <div class="container">
        <div class="stats-grid">
            ...
            <div class="stat-item" data-aos="zoom-in" data-aos-duration="800">
                <div class="stat-number"><?php echo e($jumlahDestinasi); ?></div>
        ...
        <div class="destinasi-list">
            ...
            <div class="destinasi-item" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="destinasi-content">
                    ...
                    <a href="<?php echo e(url('/geosite/tele')); ?>" class="destinasi-link">Jelajahi Lebih Lanjut →</a>
                </div>
            </div>
            ...
            <div class="destinasi-item reverse" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                ...
                <div class="destinasi-content">
                    ...
                    <a href="<?php echo e(url('/geosite/efrata')); ?>" class="destinasi-link">Jelajahi Lebih Lanjut →</a>
                </div>
            </div>
            ...
            <div class="destinasi-item" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                ...
                <div class="destinasi-content">
                    ...
                    <a href="<?php echo e(url('/geosite/sihotang')); ?>" class="destinasi-link">Jelajahi Lebih Lanjut →</a>
                </div>
            </div>
            ...
            <div class="destinasi-content">
                ...
                <div class="destinasi-location">
                    ...
                    <a href="<?php echo e(url('/geosite/sibeabea')); ?>" class="destinasi-link">
            ...
            <div class="destinasi-item" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                ...
                <div class="destinasi-location">
                    ...
                    <a href="<?php echo e(url('/geosite/holbung')); ?>" class="destinasi-link">
                        Jelajahi Lebih Lanjut →
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/pages/home.blade.php ENDPATH**/ ?>