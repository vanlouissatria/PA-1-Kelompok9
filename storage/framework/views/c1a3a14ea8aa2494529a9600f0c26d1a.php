...
<div class="card card-bi">
    <div class="card-header card-header-bi">
        <h5><i class="fas fa-plus-circle me-2" style="color: #D4AF37;"></i> Tambah Foto Galeri</h5>
    </div>
    ...
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/galeri')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="gambar" class="form-control form-control-bi" accept="image/*" id="imgInput" required>
            ...
            <div class="d-flex gap-3">
                <button type="submit" class="btn btn-bi-primary"><i class="fas fa-save me-2"></i> Simpan Galeri</button>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA 1\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/galeri/create.blade.php ENDPATH**/ ?>