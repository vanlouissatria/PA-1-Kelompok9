...
<div class="card">
    <div class="card-header">
        <h5><i class="fas fa-info-circle me-2"></i> Edit Informasi: <?php echo e($informasi->judul); ?></h5>
    </div>

    <div class="card-body p-4">
        <form action="<?php echo e(url('/admin/geosite/'.$geosite.'/informasi/'.$informasi->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            
            <div class="mb-4">
                <label class="form-label required">Judul Informasi</label>
                <input type="text" name="judul" class="form-control" value="<?php echo e(old('judul', $informasi->judul)); ?>" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label required">Isi Konten</label>
                <textarea name="isi" class="form-control" rows="10" required><?php echo e(old('isi', $informasi->konten)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Geosite-Tele-Efrata-Sihotang\resources\views/admin/tele/informasi/edit.blade.php ENDPATH**/ ?>