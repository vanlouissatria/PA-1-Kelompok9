...
<div class="page-actions">
    ...
    <a href="<?php echo e(route('admin.users.create')); ?>" class="btn-bi-tambah">
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge-role <?php echo e($admin->role); ?>">
                            <i class="fas fa-<?php echo e($admin->role === 'superadmin' ? 'crown' : 'user'); ?>"></i>
                            <?php echo e($admin->role === 'superadmin' ? 'Super Admin' : 'Admin'); ?>
                    ...
                    <td style="white-space: nowrap;">
                        <div class="actions-group">
                            <a href="<?php echo e(route('admin.users.edit', $admin->id)); ?>"
                               class="action-btn btn-edit"
                               title="Edit akun ini">
                                <i class="fas fa-pen"></i>
                            </a>
                            <form action="<?php echo e(route('admin.users.destroy', $admin->id)); ?>"
                                  method="POST"
                                  onsubmit="return confirm('Hapus akun admin <?php echo e(addslashes($admin->name)); ?>? Tindakan ini tidak bisa dibatalkan.')"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Geosite-Tele-Efrata-Sihotang\resources\views/admin/users/index.blade.php ENDPATH**/ ?>