...
<div class="card card-bi">
    <div class="card-header card-header-bi">
        <h5><i class="fas fa-edit me-2" style="color: #D4AF37;"></i> Edit UMKM: {{ $umkm->nama_usaha }}</h5>
    </div>
        ...
        <form action="{{ url('/admin/geosite/'.$geosite.'/umkm/'.$umkm->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="nama_usaha" class="form-control form-control-bi" value="{{ old('nama_usaha', $umkm->nama_usaha) }}" required>
                </div>
                
                <div class="col-md-6 mb-4">
                    <label class="form-label-bi">Pemilik *</label>
                    <input type="text" name="pemilik" class="form-control form-control-bi" value="{{ old('pemilik', $umkm->pemilik) }}" required>
                </div>
