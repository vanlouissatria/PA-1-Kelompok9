{{-- resources/views/admin/geosite/penginapan/index.blade.php --}}
...
<div class="page-actions">
    <div>
        <h1 class="page-header-title">Data Penginapan {{ $geositeTitle }}</h1>
    </div>
    <a href="{{ url('/admin/geosite/'.$geosite.'/penginapan/create') }}" class="btn-bi-tambah">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="white-space: nowrap; width: 1%;">
                        <div class="actions-group">                            
                            ...
                            {{-- Hapus --}}
                            <form action="{{ url('/admin/geosite/'.$geosite.'/penginapan/'.$item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus penginapan ini?');" class="d-inline-block" style="margin: 0; padding: 0;">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="8" class="text-center py-5 text-secondary">
                        Data penginapan masih kosong. <a href="{{ url('/admin/geosite/'.$geosite.'/penginapan/create') }}" class="text-decoration-none" style="color: var(--bi-blue);">Tambah sekarang</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
