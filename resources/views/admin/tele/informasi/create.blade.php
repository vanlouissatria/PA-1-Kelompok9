    ...
    <div class="card-body p-4">
        ...
        <form action="{{ url('/admin/geosite/'.$geosite.'/informasi') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" class="form-control form-control-bi" value="{{ old('judul') }}" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label-bi">Isi Konten *</label>
                <textarea name="isi" class="form-control form-control-bi" rows="10" required>{{ old('isi') }}</textarea>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ url('/admin/geosite/'.$geosite.'/informasi') }}" class="btn btn-bi-outline"><i class="fas fa-arrow-left me-2"></i> Batal</a>
            </div>
        </form>
    </div>
</div>
