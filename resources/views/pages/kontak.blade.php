    ...
    <div class="container">
        ...
        <div class="kontak-grid" data-aos="fade-up">
            @forelse($kontaks as $kontak)
                ...
                <div class="kontak-person-card" data-map-src="{{ $kontak->embed_maps }}" data-map-name="{{ $kontak->judul }}">
                    <div>
                        <h4>{{ $kontak->judul }}</h4>
                        @if($kontak->subjudul)
                        ...
                        @if($kontak->email1 || $kontak->email2 || $kontak->email3)
                            <div class="kontak-row">
                                <div class="detail-group">
                                    ...
                                    @foreach([$kontak->email1, $kontak->email2, $kontak->email3] as $email)
                                        @if($email)
        ...
        <div class="kontak-map-card" data-aos="fade-up" data-aos-delay="100">
            <div class="map-wrapper">
                <iframe id="kontak-map-iframe" src="{{ $initialSrc ?? '' }}" loading="lazy" allowfullscreen style="{{ empty($initialSrc) ? 'display:none;' : '' }}"></iframe>
            ...
            <div class="map-footer">
                <h4>Lokasi: <span id="map-active-label">{{ $initialName ?? 'Tidak tersedia' }}</span></h4>
                <p>Klik kartu kontak di atas untuk melihat lokasinya di peta.</p>
                <div class="social-icons">
                    @if($socialFacebook ?? false) <span class="social-icon"><i class="fab fa-facebook-f"></i></span> @endif
                    @if($socialInstagram ?? false) <span class="social-icon"><i class="fab fa-instagram"></i></span> @endif
                    @if($socialTwitter ?? false) <span class="social-icon"><i class="fab fa-twitter"></i></span> @endif
                    @if($socialYoutube ?? false) <span class="social-icon"><i class="fab fa-youtube"></i></span> @endif
                    @if($socialTiktok ?? false) <span class="social-icon"><i class="fab fa-tiktok"></i></span> @endif
                </div>
            </div>
        </div>
