...
<section id="sejarah" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Sejarah & Budaya Sibea Bea</h2>
            <div class="divider"></div>
        </div>
        <div class="sejarah-grid">
            <div class="sejarah-item" data-aos="fade-right">
                <div class="sejarah-image"><img src="{{ asset('image/meat/meat-detail.jpg') }}" alt="Sibea Bea"></div>
                <div class="sejarah-text"><h4>Panorama Alam</h4><p>Sibea Bea menawarkan pemandangan Danau Toba yang memukau, udara sejuk, dan pengalaman wisata budaya yang kuat.</p></div>
            </div>
            <div class="sejarah-item reverse" data-aos="fade-left">
                <div class="sejarah-image"><img src="{{ asset('image/meat/meat-hero.jpg') }}" alt="Sibea Bea"></div>
                <div class="sejarah-text"><h4>Budaya Batak</h4><p>Budaya Batak masih hidup di Sibea Bea melalui rumah adat, tarian, dan kerajinan lokal yang dikenalkan kepada pengunjung.</p></div>
            </div>
            <div class="sejarah-item" data-aos="fade-right">
                <div class="sejarah-image"><img src="{{ asset('image/meat/slide1.jpg') }}" alt="Sibea Bea"></div>
...
<section id="informasi" class="section" style="background: var(--light);">
    <div class="container">
        ...
        @else
            <div class="informasi-card" data-aos="fade-up">
                <div class="informasi-content"><h3>Informasi Umum Sibea Bea</h3><div class="informasi-text"><p>Wisata Sibea Bea buka setiap hari. Akses mudah dari Pangururan dan Tomok, dengan pilihan paket wisata budaya dan alam.</p><p>Pastikan membawa perlengkapan nyaman dan kamera untuk menangkap pemandangan Danau Toba.</p></div></div>
            </div>
        @endif
    </div>
</section>
