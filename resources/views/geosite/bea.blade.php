...
<head>
    ...
    <title>Bea - Geosite Danau Toba</title>
...
<section id="sejarah" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Sejarah & Budaya Bea</h2>
            <div class="divider"></div>
        </div>
        <div class="sejarah-grid">
            <div class="sejarah-item" data-aos="fade-right">
                <div class="sejarah-image"><img src="{{ asset('image/meat/meat-detail.jpg') }}" alt="Bea"></div>
                <div class="sejarah-text"><h4>Panorama Alam</h4><p>Bea menawarkan pemandangan Danau Toba yang memukau, udara sejuk, dan pengalaman wisata budaya yang kuat.</p></div>
            </div>
            <div class="sejarah-item reverse" data-aos="fade-left">
                <div class="sejarah-image"><img src="{{ asset('image/meat/meat-hero.jpg') }}" alt="Bea"></div>
                <div class="sejarah-text"><h4>Budaya Batak</h4><p>Budaya Batak masih hidup di Bea melalui rumah adat, tarian, dan kerajinan lokal yang dikenalkan kepada pengunjung.</p></div>
            </div>
            <div class="sejarah-item" data-aos="fade-right">
                <div class="sejarah-image"><img src="{{ asset('image/meat/slide1.jpg') }}" alt="Bea"></div>
...
<section id="informasi" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Informasi Wisata Bea</h2>
            <div class="divider"></div>
            <p>Persiapkan perjalanan Anda dengan informasi terbaru seputar Bea.</p>
        </div>
        ...
        @else
            <div class="informasi-card" data-aos="fade-up">
                <div class="informasi-content"><h3>Informasi Umum Bea</h3><div class="informasi-text"><p>Wisata Bea buka setiap hari. Akses mudah dari Pangururan dan Tomok, dengan pilihan paket wisata budaya dan alam.</p><p>Pastikan membawa perlengkapan nyaman dan kamera untuk menangkap pemandangan Danau Toba.</p></div></div>
            </div>
        @endif
    </div>
</section>
...
<section id="galeri" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Galeri Bea</h2>
            <div class="divider"></div>
            <p>Dokumentasi pemandangan dan aktivitas wisata di Bea.</p>
        </div>
        <div class="galeri-grid">
            ...
            @empty
                <div class="empty-state"><i class="fas fa-images"></i><p>Belum ada galeri Bea.</p></div>
            @endforelse
        </div>
    </div>
</section>
...
<section id="umkm" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>UMKM Lokal</h2>
            <div class="divider"></div>
            <p>Produk usaha masyarakat sekitar Bea.</p>
        </div>
        <div class="grid-umkm">
            ...
            @empty
                <div class="empty-state"><i class="fas fa-store"></i><p>Belum ada data UMKM untuk Bea.</p></div>
            @endforelse
        </div>
    </div>
</section>
...
<section id="penginapan" class="section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Penginapan</h2>
            <div class="divider"></div>
            <p>Rekomendasi tempat menginap di sekitar Bea.</p>
        </div>
        <div class="grid-penginapan">
            ...
            @empty
                <div class="empty-state"><i class="fas fa-hotel"></i><p>Belum ada data penginapan untuk Bea.</p></div>
            @endforelse
        </div>
    </div>
</section>
...
<section id="fasilitas" class="section" style="background: var(--light);">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Fasilitas</h2>
            <div class="divider"></div>
            <p>Fasilitas pendukung wisata di Bea.</p>
        </div>
        <div class="grid-fasilitas">
            ...
            @empty
                <div class="empty-state"><i class="fas fa-concierge-bell"></i><p>Belum ada data fasilitas untuk Bea.</p></div>
            @endforelse
        </div>
    </div>
</section>
    ...
    <div class="footer-container">
        <div class="footer-content">
            ...
            <div class="footer-info">
                <p><i class="fas fa-map-marker-alt"></i> Pulau Bea, Kabupaten Samosir</p>
